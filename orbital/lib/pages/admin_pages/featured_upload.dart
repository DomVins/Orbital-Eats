...
class Upload1 extends StatefulWidget {
  const Upload1({Key? key}) : super(key: key);

  @override
  State<Upload1> createState() => _Upload1State();
}
...
class _Upload1State extends State<Upload1> {
  ...
  saveItemInfo(String downloadUrl) {
    final itemsRef = FirebaseFirestore.instance.collection("featured");
    itemsRef.doc().set({
  ...
  Future<String> uploadFoodImage(File image) async {
    ...
    Reference featured = storage.ref("featured");
